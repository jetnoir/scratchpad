...
#ifndef SCRATCHPAD_SWIFT_H
#define SCRATCHPAD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Scratchpad",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSWindow;
SWIFT_CLASS("_TtC10Scratchpad11AppDelegate")
@interface AppDelegate : NSObject <NSApplicationDelegate, NSWindowDelegate>
- (void)applicationDidFinishLaunching:(NSNotification * _Nonnull)notification;
- (void)statusBarButtonClickedWithSender:(NSStatusBarButton * _Nonnull)sender;
- (void)toggleWindow;
